...
permute treatment_post beta=_b[treatment_post] se=_se[treatment_post] df=e(df_r), reps(588) seed(1008) saving("stimulations.dta"): reghdfe ln_NO2 treatment_post temperature windspeed winddirection pressure rh precipitation ln_cloudfraction is_holiday, absorb(sitenum dow month ) vce(cluster sitenum)
